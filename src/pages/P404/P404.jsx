...
const P404 = () => {
  return(
    <div className="content xl:bg-[url(/assets/img/wallpaper-404.png)] bg-[url(/assets/img/wallpaper-404-mobile.png)]">
      <img className="w-auto h-40 xl:h-100 mt-5" src="/assets/img/404.png" />
